...
//
//		writeModel(module, "src/resources/cases/", "case_1_changeEdge.henshin", refinedMetamodelWrapper.refinedMetamodel, refinedMetamodelWrapper)
//		
//		assertEquals("Change_encapsulates_edge_for_Class_rules", module.name);
