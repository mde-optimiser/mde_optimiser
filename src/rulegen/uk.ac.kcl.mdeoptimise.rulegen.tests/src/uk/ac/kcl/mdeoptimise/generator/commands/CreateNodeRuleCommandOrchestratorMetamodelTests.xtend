...
@RunWith(XtextRunner)
class CreateNodeRuleCommandOrchestratorMetamodelTests {
	...
	def void assertThatCase1CreateNodeRulesAreGenerated() {
		...
		writeModel(module, "src/resources/cases/", "case_1_rule_1_create_node_a_orchestrator.henshin", refinedMetamodelWrapper.refinedMetamodel, refinedMetamodelWrapper)
