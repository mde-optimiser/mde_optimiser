...
class CreateNodeRuleCommandTests {
	...
	def void assertThatCase1CreateNodeRulesAreGenerated() {
		...
		writeModel(module, "src/resources/cases/", "case_1_create_node_a.henshin", refinedMetamodelWrapper.refinedMetamodel, refinedMetamodelWrapper)
	...
	def void assertThatCase2CreateNodeRulesAreGenerated() {
		...
		writeModel(module, "src/resources/cases/", "case_2_create_node_a.henshin", refinedMetamodelWrapper.refinedMetamodel, refinedMetamodelWrapper)
