...
//
//@RunWith(XtextRunner)
//class ChangeEdgeRuleCommandOrchestratorTests {
//	
...
//		var edge = refinedMetamodelWrapper.getEdge("Orchestrator", "deployedOn");
//		
...
//
//		writeModel(module, "src/resources/cases/", "Change_deployedOn_edge_for_Orchestrator_rules.henshin", refinedMetamodelWrapper.refinedMetamodel, refinedMetamodelWrapper)
//		
//		assertEquals("Change_deployedOn_edge_for_Orchestrator_rules", module.name);
