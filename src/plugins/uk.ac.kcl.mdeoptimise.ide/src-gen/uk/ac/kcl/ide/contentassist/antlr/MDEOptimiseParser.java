...
public class MDEOptimiseParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MDEOptimiseGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MDEOptimiseGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOptimisationAccess().getBasepathAssignment_0(), "rule__Optimisation__BasepathAssignment_0");
			builder.put(grammarAccess.getOptimisationAccess().getMetamodelAssignment_1(), "rule__Optimisation__MetamodelAssignment_1");
			builder.put(grammarAccess.getOptimisationAccess().getModelAssignment_2(), "rule__Optimisation__ModelAssignment_2");
			builder.put(grammarAccess.getOptimisationAccess().getModelInitialiserAssignment_3(), "rule__Optimisation__ModelInitialiserAssignment_3");
			builder.put(grammarAccess.getOptimisationAccess().getRefinementsAssignment_4(), "rule__Optimisation__RefinementsAssignment_4");
			builder.put(grammarAccess.getOptimisationAccess().getObjectivesAssignment_5(), "rule__Optimisation__ObjectivesAssignment_5");
			builder.put(grammarAccess.getOptimisationAccess().getConstraintsAssignment_6(), "rule__Optimisation__ConstraintsAssignment_6");
			builder.put(grammarAccess.getOptimisationAccess().getReportsAssignment_7(), "rule__Optimisation__ReportsAssignment_7");
			builder.put(grammarAccess.getOptimisationAccess().getEvolversAssignment_8(), "rule__Optimisation__EvolversAssignment_8");
			builder.put(grammarAccess.getOptimisationAccess().getRulegenAssignment_9(), "rule__Optimisation__RulegenAssignment_9");
			builder.put(grammarAccess.getOptimisationAccess().getOptimisationAssignment_10(), "rule__Optimisation__OptimisationAssignment_10");
