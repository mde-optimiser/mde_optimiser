		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOptimisationAccess().getObjectivesAssignment_2(), "rule__Optimisation__ObjectivesAssignment_2");
					put(grammarAccess.getOptimisationAccess().getConstraintsAssignment_3(), "rule__Optimisation__ConstraintsAssignment_3");
					put(grammarAccess.getOptimisationAccess().getEvolversAssignment_4(), "rule__Optimisation__EvolversAssignment_4");
					put(grammarAccess.getOptimisationAccess().getOptimisationAssignment_5(), "rule__Optimisation__OptimisationAssignment_5");
