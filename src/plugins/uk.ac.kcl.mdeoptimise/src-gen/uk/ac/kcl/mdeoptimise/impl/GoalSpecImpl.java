 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.mdeoptimise.impl.GoalSpecImpl#getRefinements <em>Refinements</em>}</li>
 *   <li>{@link uk.ac.kcl.mdeoptimise.impl.GoalSpecImpl#getObjectives <em>Objectives</em>}</li>
 *   <li>{@link uk.ac.kcl.mdeoptimise.impl.GoalSpecImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoalSpecImpl extends MinimalEObjectImpl.Container implements GoalSpec
{
  ...
  {
    return MdeoptimisePackage.Literals.GOAL_SPEC;
  }
  ...
  public EList<MultiplicityRefinementSpec> getRefinements()
  {
    if (refinements == null)
    {
      refinements = new EObjectContainmentEList<MultiplicityRefinementSpec>(MultiplicityRefinementSpec.class, this, MdeoptimisePackage.GOAL_SPEC__REFINEMENTS);
    }
    return refinements;
  }
  ...
  public EList<ObjectiveInterpreterSpec> getObjectives()
  {
    if (objectives == null)
    {
      objectives = new EObjectContainmentEList<ObjectiveInterpreterSpec>(ObjectiveInterpreterSpec.class, this, MdeoptimisePackage.GOAL_SPEC__OBJECTIVES);
    }
    return objectives;
  }
  ...
  public EList<ConstraintInterpreterSpec> getConstraints()
  {
    if (constraints == null)
    {
      constraints = new EObjectContainmentEList<ConstraintInterpreterSpec>(ConstraintInterpreterSpec.class, this, MdeoptimisePackage.GOAL_SPEC__CONSTRAINTS);
    }
    return constraints;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MdeoptimisePackage.GOAL_SPEC__REFINEMENTS:
        return ((InternalEList<?>)getRefinements()).basicRemove(otherEnd, msgs);
      case MdeoptimisePackage.GOAL_SPEC__OBJECTIVES:
        return ((InternalEList<?>)getObjectives()).basicRemove(otherEnd, msgs);
      case MdeoptimisePackage.GOAL_SPEC__CONSTRAINTS:
