...
public class AddEdgeRuleCommand implements IRuleGenerationCommand {
	...
	public AddEdgeRuleCommand(MetamodelWrapper metamodelWrapper, RuleSpec ruleSpec, RepairSpec repairSpec) {
		this.metamodelWrapper = metamodelWrapper;
		this.ruleSpec = ruleSpec;
		this.repairSpec = repairSpec;
	}

	public AddEdgeRuleCommand(EClass node, MetamodelWrapper metamodelWrapper, RuleSpec ruleSpec, RepairSpec repairSpecs) {
		this.metamodelWrapper = metamodelWrapper;
		this.node = node;
	...
	public Module generate() {
		...
		module.setDescription("Adds to " + this.getNode().getName() + " edge of type " + this.getEdge().getName());
	...
	private Rule createRule(EClass source, EReference outReference, EClass target) {
		...
		var sourceNode = HenshinFactory.eINSTANCE.createNode(graph, selectedNodePair.getLhsNode().getType(), "");
		var targetNode = HenshinFactory.eINSTANCE.createNode(graph, newNodePair.getLhsNode().getType(), "");
