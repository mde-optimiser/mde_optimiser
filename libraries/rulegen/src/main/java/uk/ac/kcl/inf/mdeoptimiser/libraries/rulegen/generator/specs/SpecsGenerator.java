...
public class SpecsGenerator {
	...
	public Map<String, Set<List<RepairSpec>>> getRepairsForRuleSpec(RuleSpec ruleSpec, MetamodelWrapper metamodelWrapper){
	...
	public Set<List<RepairSpec>> generateNodeRepairCombinations(Map<EReference, Set<RepairSpec>> repairSpecs){
	...
	public Map<EReference, Set<RepairSpec>> generateNodeCreateRules(RuleSpec ruleSpec, MetamodelWrapper metamodelWrapper){
	...
	public Map<EReference, Set<RepairSpec>> generateNodeDeleteRules(RuleSpec ruleSpec, MetamodelWrapper metamodelWrapper){
		...
		node.getEReferences().forEach(edge -> {
			...
			if(edge.getEOpposite() == null || edge.getEOpposite().getLowerBound() == 0){
				...
				if(edge.getEOpposite().getLowerBound() > 0
					&& (edge.getEOpposite().getUpperBound() > edge.getEOpposite().getLowerBound() || edge.getEOpposite().getUpperBound() == -1)
				) {
					repairs.add(new RepairSpec(node, edge, RepairSpecType.DELETE));
				}
	...
	public Map<EReference, Set<RepairSpec>> generateEdgeAddRules(RuleSpec ruleSpec, MetamodelWrapper metamodelWrapper){
...
//				}
	...
	public Map<EReference, Set<RepairSpec>> generateEdgeRemoveRules(RuleSpec ruleSpec, MetamodelWrapper metamodelWrapper){
