...
public class Multiplicity {
  ...
  public Integer problemLower;
  public Integer problemUpper;
  ...
  public Multiplicity(
      String sourceNode, String edge, Integer lower, Integer upper, EPackage metamodel) {
  ...
  public EReference getEReference() {
    ...
    if (this.eReference == null) {
      ...
      this.eReference =
          ((EClass) nodeClassifier)
              .getEAllReferences().stream()
                  .filter(
                      reference ->
                          reference.getName().equals(edge)
  ...
  public void setProblemUpper(Integer problemUpper) {
    this.problemUpper = problemUpper;
  }

  public void setProblemLower(Integer problemLower) {
    this.problemLower = problemLower;
  }

  public Integer getProblemUpper() {
    return this.problemUpper;
  }

  public Integer getProblemLower() {
    return this.problemLower;
  }
}
