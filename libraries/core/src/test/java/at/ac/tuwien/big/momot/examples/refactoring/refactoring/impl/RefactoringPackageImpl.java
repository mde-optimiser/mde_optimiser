...
public class RefactoringPackageImpl extends EPackageImpl implements RefactoringPackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link RefactoringPackage#eINSTANCE} when that field is
  ...
  public static RefactoringPackage init() {
    if (isInited)
      return (RefactoringPackage)
          EPackage.Registry.INSTANCE.getEPackage(RefactoringPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredRefactoringPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    RefactoringPackageImpl theRefactoringPackage =
        registeredRefactoringPackage instanceof RefactoringPackageImpl
            ? (RefactoringPackageImpl) registeredRefactoringPackage
  ...
  public void initializePackageContents() {
    ...
    initEReference(
        ...
        IS_ORDERED);
    initEReference(
        getEntity_Specialization(),
        this.getGeneralization(),
        this.getGeneralization_General(),
        "specialization",
        null,
        0,
        -1,
        ...
        IS_ORDERED);
    initEReference(
        getEntity_Generalization(),
        this.getGeneralization(),
        this.getGeneralization_Specific(),
        "generalization",
        null,
        0,
        1,
    ...
    initEClass(
        typeEClass, Type.class, "Type", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(
        refactoringModelEClass,
        RefactoringModel.class,
        "RefactoringModel",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getRefactoringModel_Properties(),
        this.getProperty(),
        null,
        "properties",
        null,
    ...
    initEReference(
        ...
        IS_ORDERED);
    initEReference(
        getRefactoringModel_Generalizations(),
        this.getGeneralization(),
        null,
        "generalizations",
        null,
