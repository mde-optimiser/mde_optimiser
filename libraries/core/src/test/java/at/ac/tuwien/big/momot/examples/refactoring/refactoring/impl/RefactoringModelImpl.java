 ...
 * <ul>
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.RefactoringModelImpl#getProperties
 *       <em>Properties</em>}
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.RefactoringModelImpl#getEntities
 *       <em>Entities</em>}
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.RefactoringModelImpl#getTypes
 *       <em>Types</em>}
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.RefactoringModelImpl#getGeneralizations
...
public class RefactoringModelImpl extends MinimalEObjectImpl.Container implements RefactoringModel {
  ...
  /**
   * The cached value of the '{@link #getGeneralizations() <em>Generalizations</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<Property> getProperties() {
    if (properties == null) {
      properties =
          new EObjectContainmentEList<Property>(
              Property.class, this, RefactoringPackage.REFACTORING_MODEL__PROPERTIES);
    }
    return properties;
  }
  ...
  public EList<Entity> getEntities() {
    if (entities == null) {
      entities =
          new EObjectContainmentEList<Entity>(
              Entity.class, this, RefactoringPackage.REFACTORING_MODEL__ENTITIES);
    }
    return entities;
  }
  ...
  public EList<Type> getTypes() {
    if (types == null) {
      types =
          new EObjectContainmentEList<Type>(
              Type.class, this, RefactoringPackage.REFACTORING_MODEL__TYPES);
    }
    return types;
  }
  ...
  public EList<Generalization> getGeneralizations() {
    if (generalizations == null) {
      generalizations =
          new EObjectContainmentEList<Generalization>(
              Generalization.class, this, RefactoringPackage.REFACTORING_MODEL__GENERALIZATIONS);
    }
