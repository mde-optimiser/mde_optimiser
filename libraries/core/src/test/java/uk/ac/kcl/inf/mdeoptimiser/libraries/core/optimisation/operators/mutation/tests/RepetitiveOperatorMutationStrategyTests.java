...
public class RepetitiveOperatorMutationStrategyTests {
  ...
  public void assertThatOperatorsAreExecutedRepetitively() {
    ...
    var expectedOperators = List.of("test", "test", "test", "test", "test");

    var mutationStrategy =
        new RepetitiveOperatorMutationStrategy(
            this.henshinExecutor, mutationStepSizeStrategy, operatorSelectionDecorator);
    ...
    verify(operatorSelectionDecorator, times(1)).getNextOperator();
