...
class CaseStudyTestsRandomMutationStrategy {
	...
	@Test
	def void craRulegenMutationStepSizeFixedStrategyBMutationStrategyRandom(TestInfo testInfo) {
	...
	@Test
	def void craRulegenMutationStepSizeFixedStrategyBMutationStrategyRepetitive(TestInfo testInfo) {
	...
	@Test
	def void craRulegenMutationStepSizeIntervalStrategyB(TestInfo testInfo) {
