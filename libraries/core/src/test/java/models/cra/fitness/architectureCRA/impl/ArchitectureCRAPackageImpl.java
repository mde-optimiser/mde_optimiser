...
public class ArchitectureCRAPackageImpl extends EPackageImpl implements ArchitectureCRAPackage {
  ...
  public static ArchitectureCRAPackage init() {
    if (isInited) return (ArchitectureCRAPackage) Registry.INSTANCE.getEPackage(eNS_URI);

    // Obtain or create and register package
    Object registeredArchitectureCRAPackage = Registry.INSTANCE.get(eNS_URI);
    ...
    Registry.INSTANCE.put(eNS_URI, theArchitectureCRAPackage);
