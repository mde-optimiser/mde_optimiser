...
public class OCLScriptEngine extends AbstractScriptEngine {
  ...
  protected static final String LET_EXPRESSION_STRING =
      "let " + ATTRIBUTE_DEFINITION_STRING + " in";
  ...
  public Boolean evalAsAttributeDefinitions(final String script, final ScriptContext context)
