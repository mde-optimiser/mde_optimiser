/**
 * ***************************************************************************** Copyright (c) 2015
 * Vienna University of Technology. All rights reserved. This program and the accompanying materials
 * are made available under the terms of the Eclipse Public License v1.0 which accompanies this
 * distribution, and is available at http://www.eclipse.org/legal/epl-v10.html
 *
 * <p>Contributors: Martin Fleck (Vienna University of Technology) - initial API and implementation
 *
 * <p>Initially developed in the context of ARTIST EU project www.artist-project.eu
 * *****************************************************************************
 */
...
public final class MathUtil {
  ...
  public static double[] normalize(
      final double[] vector, final double[] minima, final double[] maxima) {
  ...
  public static double rescale(
      final double value,
      final double oldScaleMin,
      final double oldScaleMax,
      final double newScaleMin,
      final double newScaleMax) {
    return (value - oldScaleMin) / (oldScaleMax - oldScaleMin) * (newScaleMax - newScaleMin)
        + newScaleMin;
  }

  public static double rescale(
      final double value, final RealVariable oldScale, final RealVariable newScale) {
    final double newValue =
        rescale(
            value,
            oldScale.getLowerBound(),
            oldScale.getUpperBound(),
            newScale.getLowerBound(),
            newScale.getUpperBound());
    return newValue;
  }
  ...
  public static long toNanoseconds(
      final int days,
      final int hours,
      final int minutes,
      final int seconds,
