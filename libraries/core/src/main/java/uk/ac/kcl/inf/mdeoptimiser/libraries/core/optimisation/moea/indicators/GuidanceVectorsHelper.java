package uk.ac.kcl.inf.mdeoptimiser.libraries.core.optimisation.moea.indicators;
...
/**
 * This helper identifies a reference point from a set of given solutions. The reference point is
 * calculated by taking the worse value for all the objectives from the supplied solutions.
 */
