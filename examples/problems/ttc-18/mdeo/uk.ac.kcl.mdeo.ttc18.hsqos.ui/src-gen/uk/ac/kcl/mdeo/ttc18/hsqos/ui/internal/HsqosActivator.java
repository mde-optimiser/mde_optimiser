 ...
 */
package uk.ac.kcl.mdeo.ttc18.hsqos.ui.internal;
 ...
 * introduced subclass. 
 */
public class HsqosActivator extends AbstractUIPlugin {

	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(HsqosActivator.class);
	
	private static HsqosActivator INSTANCE;
	...
	public static HsqosActivator getInstance() {
		return INSTANCE;
	}
