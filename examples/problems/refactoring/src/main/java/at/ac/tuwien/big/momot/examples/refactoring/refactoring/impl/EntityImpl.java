 ...
 * <ul>
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.EntityImpl#getOwnedAttribute
 *       <em>Owned Attribute</em>}
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.EntityImpl#getSpecialization
 *       <em>Specialization</em>}
 *   <li>{@link
 *       at.ac.tuwien.big.momot.examples.refactoring.refactoring.impl.EntityImpl#getGeneralization
...
public class EntityImpl extends NamedElementImpl implements Entity {
  ...
  public EList<Property> getOwnedAttribute() {
    if (ownedAttribute == null) {
      ownedAttribute =
          new EObjectResolvingEList<Property>(
              Property.class, this, RefactoringPackage.ENTITY__OWNED_ATTRIBUTE);
    }
  ...
  public EList<Generalization> getSpecialization() {
    if (specialization == null) {
      specialization =
          new EObjectWithInverseResolvingEList<Generalization>(
              Generalization.class,
              this,
              RefactoringPackage.ENTITY__SPECIALIZATION,
              RefactoringPackage.GENERALIZATION__GENERAL);
    }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  RefactoringPackage.ENTITY__GENERALIZATION,
                  oldGeneralization,
                  generalization));
      }
    }
   ...
   * @generated
   */
  public NotificationChain basicSetGeneralization(
      Generalization newGeneralization, NotificationChain msgs) {
  ...
  public void setGeneralization(Generalization newGeneralization) {
    if (newGeneralization != generalization) {
      ...
      if (generalization != null)
        msgs =
            ((InternalEObject) generalization)
                .eInverseRemove(
                    this, RefactoringPackage.GENERALIZATION__SPECIFIC, Generalization.class, msgs);
      if (newGeneralization != null)
        msgs =
            ((InternalEObject) newGeneralization)
                .eInverseAdd(
                    this, RefactoringPackage.GENERALIZATION__SPECIFIC, Generalization.class, msgs);
        ...
        if (generalization != null)
          msgs =
              ((InternalEObject) generalization)
                  .eInverseRemove(
                      this,
                      RefactoringPackage.GENERALIZATION__SPECIFIC,
                      Generalization.class,
                      msgs);
