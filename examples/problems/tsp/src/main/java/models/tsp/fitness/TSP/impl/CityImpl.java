 ...
 *
 * <ul>
 *   <li>{@link models.tsp.fitness.TSP.impl.CityImpl#getName <em>Name</em>}
 *   <li>{@link models.tsp.fitness.TSP.impl.CityImpl#isStart <em>Start</em>}
 *   <li>{@link models.tsp.fitness.TSP.impl.CityImpl#getOrigin <em>Origin</em>}
 *   <li>{@link models.tsp.fitness.TSP.impl.CityImpl#getDestination <em>Destination</em>}
 *   <li>{@link models.tsp.fitness.TSP.impl.CityImpl#getNext <em>Next</em>}
 * </ul>
 *
 * @generated
 */
public class CityImpl extends MinimalEObjectImpl.Container implements City {
  ...
  public void setStart(boolean newStart) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, TSPPackage.CITY__START, oldStart, start));
  }
  ...
  public EList<Distance> getOrigin() {
    if (origin == null) {
      origin =
          new EObjectWithInverseResolvingEList<Distance>(
              Distance.class, this, TSPPackage.CITY__ORIGIN, TSPPackage.DISTANCE__FROM);
    }
    return origin;
  }
  ...
  public EList<Distance> getDestination() {
    if (destination == null) {
      destination =
          new EObjectWithInverseResolvingEList<Distance>(
              Distance.class, this, TSPPackage.CITY__DESTINATION, TSPPackage.DISTANCE__TO);
    }
    return destination;
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this, Notification.RESOLVE, TSPPackage.CITY__NEXT, oldNext, next));
      }
    }
    return next;
  }
  ...
  public NotificationChain eInverseAdd(
    ...
    switch (featureID) {
      case TSPPackage.CITY__ORIGIN:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getOrigin())
            .basicAdd(otherEnd, msgs);
      case TSPPackage.CITY__DESTINATION:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getDestination())
            .basicAdd(otherEnd, msgs);
    }
