...
public class TSPFactoryImpl extends EFactoryImpl implements TSPFactory {
	...
	public static TSPFactory init() {
		try {
			TSPFactory theTSPFactory = (TSPFactory)EPackage.Registry.INSTANCE.getEFactory(TSPPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TSPPackage.REGION: return createRegion();
			case TSPPackage.CITY: return createCity();
			case TSPPackage.DISTANCE: return createDistance();
			default:
