 ...
 *
 * <ul>
 *   <li>{@link models.scrum.planning.SprintPlanning.impl.PlanImpl#getStakeholders
 *       <em>Stakeholders</em>}
 *   <li>{@link models.scrum.planning.SprintPlanning.impl.PlanImpl#getBacklog <em>Backlog</em>}
 *   <li>{@link models.scrum.planning.SprintPlanning.impl.PlanImpl#getSprints <em>Sprints</em>}
 * </ul>
 *
 * @generated
 */
public class PlanImpl extends MinimalEObjectImpl.Container implements Plan {
  /**
   * The cached value of the '{@link #getStakeholders() <em>Stakeholders</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<Stakeholder> getStakeholders() {
    if (stakeholders == null) {
      stakeholders =
          new EObjectContainmentEList<Stakeholder>(
              Stakeholder.class, this, SprintPlanningPackage.PLAN__STAKEHOLDERS);
    }
    return stakeholders;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SprintPlanningPackage.PLAN__BACKLOG, oldBacklog, newBacklog);
  ...
  public void setBacklog(Backlog newBacklog) {
    if (newBacklog != backlog) {
      ...
      if (backlog != null)
        msgs =
            ((InternalEObject) backlog)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SprintPlanningPackage.PLAN__BACKLOG, null, msgs);
      if (newBacklog != null)
        msgs =
            ((InternalEObject) newBacklog)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SprintPlanningPackage.PLAN__BACKLOG, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SprintPlanningPackage.PLAN__BACKLOG, newBacklog, newBacklog));
  }
  ...
  public EList<Sprint> getSprints() {
    if (sprints == null) {
      sprints =
          new EObjectContainmentEList<Sprint>(
              Sprint.class, this, SprintPlanningPackage.PLAN__SPRINTS);
    }
    return sprints;
  }
