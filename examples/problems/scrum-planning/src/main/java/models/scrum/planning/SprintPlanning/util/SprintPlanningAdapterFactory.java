/** */
package models.scrum.planning.SprintPlanning.util;

import models.scrum.planning.SprintPlanning.*;
 ...
 * <!-- end-user-doc -->
 *
 * @see models.scrum.planning.SprintPlanning.SprintPlanningPackage
 * @generated
 */
public class SprintPlanningAdapterFactory extends AdapterFactoryImpl {
   ...
   * models.scrum.planning.SprintPlanning.Stakeholder <em>Stakeholder</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * models.scrum.planning.SprintPlanning.Backlog <em>Backlog</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * models.scrum.planning.SprintPlanning.WorkItem <em>Work Item</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * models.scrum.planning.SprintPlanning.Sprint <em>Sprint</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link models.scrum.planning.SprintPlanning.Plan
   * <em>Plan</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
