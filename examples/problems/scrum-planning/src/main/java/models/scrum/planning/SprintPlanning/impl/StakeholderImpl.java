 ...
 *
 * <ul>
 *   <li>{@link models.scrum.planning.SprintPlanning.impl.StakeholderImpl#getWorkitem
 *       <em>Workitem</em>}
 * </ul>
 *
 * @generated
    ...
    if (workitem == null) {
      workitem =
          new EObjectWithInverseResolvingEList<WorkItem>(
              WorkItem.class,
              this,
              SprintPlanningPackage.STAKEHOLDER__WORKITEM,
  ...
  public NotificationChain eInverseAdd(
    ...
    switch (featureID) {
      case SprintPlanningPackage.STAKEHOLDER__WORKITEM:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getWorkitem())
