...
import models.scrum.planning.SprintPlanning.Backlog;
import models.scrum.planning.SprintPlanning.Plan;
import models.scrum.planning.SprintPlanning.Sprint;
import models.scrum.planning.SprintPlanning.SprintPlanningFactory;
...
public class SprintPlanningPackageImpl extends EPackageImpl implements SprintPlanningPackage {
   ...
   * @see models.scrum.planning.SprintPlanning.SprintPlanningPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link SprintPlanningPackage#eINSTANCE} when that field is
  ...
  public static SprintPlanningPackage init() {
    if (isInited)
      return (SprintPlanningPackage)
          EPackage.Registry.INSTANCE.getEPackage(SprintPlanningPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredSprintPlanningPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    SprintPlanningPackageImpl theSprintPlanningPackage =
        registeredSprintPlanningPackage instanceof SprintPlanningPackageImpl
            ? (SprintPlanningPackageImpl) registeredSprintPlanningPackage
            : new SprintPlanningPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEReference(
        getStakeholder_Workitem(),
        this.getWorkItem(),
        this.getWorkItem_Stakeholder(),
        "workitem",
        null,
        1,
        -1,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getWorkItem_IsPlannedFor(),
        this.getSprint(),
        this.getSprint_CommittedItem(),
        "isPlannedFor",
        null,
        0,
        1,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEReference(
        getWorkItem_Stakeholder(),
        this.getStakeholder(),
        this.getStakeholder_Workitem(),
        "stakeholder",
        null,
        1,
        1,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getSprint_CommittedItem(),
        this.getWorkItem(),
        this.getWorkItem_IsPlannedFor(),
        "committedItem",
        null,
        1,
        -1,
