/** */
package models.stack.ecore.stack.util;

import models.stack.ecore.stack.*;
 ...
 * <!-- end-user-doc -->
 *
 * @see models.stack.ecore.stack.StackPackage
 * @generated
 */
public class StackAdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link models.stack.ecore.stack.StackModel
   * <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link models.stack.ecore.stack.Stack
   * <em>Stack</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
