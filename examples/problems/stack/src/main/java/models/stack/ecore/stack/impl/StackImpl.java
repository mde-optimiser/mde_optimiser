 ...
 *
 * <ul>
 *   <li>{@link models.stack.ecore.stack.impl.StackImpl#getId <em>Id</em>}
 *   <li>{@link models.stack.ecore.stack.impl.StackImpl#getLoad <em>Load</em>}
 *   <li>{@link models.stack.ecore.stack.impl.StackImpl#getLeft <em>Left</em>}
 *   <li>{@link models.stack.ecore.stack.impl.StackImpl#getRight <em>Right</em>}
 * </ul>
 *
 * @generated
 */
public class StackImpl extends MinimalEObjectImpl.Container implements Stack {
  ...
  public void setLoad(int newLoad) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, StackPackage.STACK__LOAD, oldLoad, load));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this, Notification.RESOLVE, StackPackage.STACK__LEFT, oldLeft, left));
      }
    }
    return left;
  }
  ...
  public NotificationChain basicSetLeft(Stack newLeft, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(this, Notification.SET, StackPackage.STACK__LEFT, oldLeft, newLeft);
      ...
      if (left != null)
        msgs =
            ((InternalEObject) left)
                .eInverseRemove(this, StackPackage.STACK__RIGHT, Stack.class, msgs);
      if (newLeft != null)
        msgs =
            ((InternalEObject) newLeft)
                .eInverseAdd(this, StackPackage.STACK__RIGHT, Stack.class, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, StackPackage.STACK__LEFT, newLeft, newLeft));
  }
    ...
    if (right != null && right.eIsProxy()) {
      ...
      if (right != oldRight) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this, Notification.RESOLVE, StackPackage.STACK__RIGHT, oldRight, right));
      }
    }
    return right;
  }
  ...
  public NotificationChain basicSetRight(Stack newRight, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, StackPackage.STACK__RIGHT, oldRight, newRight);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
      ...
      if (right != null)
        msgs =
            ((InternalEObject) right)
                .eInverseRemove(this, StackPackage.STACK__LEFT, Stack.class, msgs);
      if (newRight != null)
        msgs =
            ((InternalEObject) newRight)
                .eInverseAdd(this, StackPackage.STACK__LEFT, Stack.class, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, StackPackage.STACK__RIGHT, newRight, newRight));
  }
