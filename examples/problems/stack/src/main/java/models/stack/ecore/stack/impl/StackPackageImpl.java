...
import models.stack.ecore.stack.StackFactory;
...
public class StackPackageImpl extends EPackageImpl implements StackPackage {
   ...
   * @see models.stack.ecore.stack.StackPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link StackPackage#eINSTANCE} when that field is
  ...
  public static StackPackage init() {
    ...
    StackPackageImpl theStackPackage =
        registeredStackPackage instanceof StackPackageImpl
            ? (StackPackageImpl) registeredStackPackage
