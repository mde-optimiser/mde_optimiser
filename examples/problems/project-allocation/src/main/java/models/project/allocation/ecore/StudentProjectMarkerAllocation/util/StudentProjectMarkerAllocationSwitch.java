 ...
 * @generated
 */
public class StudentProjectMarkerAllocationSwitch<T> extends Switch<T> {
  /**
   ...
   * @generated
   */
  public StudentProjectMarkerAllocationSwitch() {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case StudentProjectMarkerAllocationPackage.ACADEMIC:
        {
          Academic academic = (Academic) theEObject;
          T result = caseAcademic(academic);
      ...
      case StudentProjectMarkerAllocationPackage.MARKING_TEAM:
        {
          MarkingTeam markingTeam = (MarkingTeam) theEObject;
          T result = caseMarkingTeam(markingTeam);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      case StudentProjectMarkerAllocationPackage.MARKER_ALLOCATION_MODEL:
        {
          MarkerAllocationModel markerAllocationModel = (MarkerAllocationModel) theEObject;
          T result = caseMarkerAllocationModel(markerAllocationModel);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      default:
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Academic</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Academic</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAcademic(Academic object) {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Marking Team</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Marking Team</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMarkingTeam(MarkingTeam object) {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Marker Allocation
   * Model</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Marker Allocation
   *     Model</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMarkerAllocationModel(MarkerAllocationModel object) {
    return null;
  }
...
} // StudentProjectMarkerAllocationSwitch
