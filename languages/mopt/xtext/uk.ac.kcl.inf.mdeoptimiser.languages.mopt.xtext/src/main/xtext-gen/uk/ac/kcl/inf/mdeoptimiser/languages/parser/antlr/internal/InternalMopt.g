...
@after {
	...
	(
		...
		(
			...
			(
				(
					lv_solverEngine_3_0=RULE_SOLVER_ENGINE
					{
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"solverEngine",
							lv_solverEngine_3_0,
							"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.SOLVER_ENGINE");
					}
				)
			)
		)?
		otherlv_4='optimisation'
		{
		...
		(
			(
				lv_algorithmFactory_6_0=RULE_ALGORITHM_FACTORY
				{
