...
@parser::members {
    ...
    public InternalMoptParser(TokenStream input, MoptGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected MoptGrammarAccess getGrammarAccess() {
			...
			(
				...
				lv_problem_0_0=ruleProblemSpec
				{
					...
					set(
						...
						"problem",
						lv_problem_0_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ProblemSpec");
			...
			(
				...
				lv_goal_1_0=ruleGoalSpec
				{
					...
					set(
						...
						"goal",
						lv_goal_1_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.GoalSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_search_2_0=ruleSearchSpec
				{
					...
					set(
						...
						"search",
						lv_search_2_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.SearchSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_solver_3_0=ruleSolverSpec
				{
					...
					set(
						...
						"solver",
						lv_solver_3_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.SolverSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_basepath_2_0=ruleBasePathSpec
				{
					...
					set(
						...
						"basepath",
						lv_basepath_2_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.BasePathSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_metamodel_3_0=ruleMetaModelSpec
				{
					...
					set(
						...
						"metamodel",
						lv_metamodel_3_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.MetaModelSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_model_4_0=ruleModelPathSpec
				{
					...
					set(
						...
						"model",
						lv_model_4_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ModelPathSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_modelInitialiser_5_0=ruleModelInitialiserSpec
				{
					...
					set(
						...
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ModelInitialiserSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_refinements_2_0=ruleMultiplicityRefinementSpec
				{
					...
					add(
						...
						"refinements",
						lv_refinements_2_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.MultiplicityRefinementSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_objectives_3_0=ruleObjectiveInterpreterSpec
				{
					...
					add(
						...
						"objectives",
						lv_objectives_3_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ObjectiveInterpreterSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_constraints_4_0=ruleConstraintInterpreterSpec
				{
					...
					add(
						...
						"constraints",
						lv_constraints_4_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ConstraintInterpreterSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_reports_2_0=ruleReportInterpreterSpec
				{
					...
					add(
						...
						"reports",
						lv_reports_2_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ReportInterpreterSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_evolvers_3_0=ruleEvolverSpec
				{
					...
					add(
						...
						"evolvers",
						lv_evolvers_3_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.EvolverSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_rulegen_4_0=ruleRulegenSpec
				{
					...
					add(
						...
						"rulegen",
						lv_rulegen_4_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.RulegenSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)*
...
@after {
	...
	(
		...
		otherlv_2='optimisation'
		{
			newLeafNode(otherlv_2, grammarAccess.getSolverSpecAccess().getOptimisationKeyword_2());
		}
		otherlv_3='provider'
		{
			newLeafNode(otherlv_3, grammarAccess.getSolverSpecAccess().getProviderKeyword_3());
		}
		(
			(
				lv_algorithmFactory_4_0=RULE_ALGORITHM_FACTORY
				{
					newLeafNode(lv_algorithmFactory_4_0, grammarAccess.getSolverSpecAccess().getAlgorithmFactoryALGORITHM_FACTORYTerminalRuleCall_4_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getSolverSpecRule());
					}
					setWithLastConsumed(
						$current,
						"algorithmFactory",
						lv_algorithmFactory_4_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ALGORITHM_FACTORY");
				}
			)
		)
		otherlv_5='algorithm'
		{
			newLeafNode(otherlv_5, grammarAccess.getSolverSpecAccess().getAlgorithmKeyword_5());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getSolverSpecAccess().getAlgorithmAlgorithmSpecParserRuleCall_6_0());
				}
				lv_algorithm_6_0=ruleAlgorithmSpec
				{
					if ($current==null) {
					...
					set(
						...
						"algorithm",
						lv_algorithm_6_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.AlgorithmSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
		otherlv_7='termination'
		{
			newLeafNode(otherlv_7, grammarAccess.getSolverSpecAccess().getTerminationKeyword_7());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getSolverSpecAccess().getTerminationConditionTerminationConditionSpecParserRuleCall_8_0());
				}
				lv_terminationCondition_8_0=ruleTerminationConditionSpec
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getSolverSpecRule());
					}
					set(
						...
						lv_terminationCondition_8_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.TerminationConditionSpec");
					afterParserOrEnumRuleCall();
				}
			)
		)
		(
			otherlv_9='batches'
			{
				newLeafNode(otherlv_9, grammarAccess.getSolverSpecAccess().getBatchesKeyword_9_0());
			}
			(
				(
					lv_algorithmBatches_10_0=RULE_INT
					{
						newLeafNode(lv_algorithmBatches_10_0, grammarAccess.getSolverSpecAccess().getAlgorithmBatchesINTTerminalRuleCall_9_1_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getSolverSpecRule());
		...
		otherlv_11='}'
		{
			newLeafNode(otherlv_11, grammarAccess.getSolverSpecAccess().getRightCurlyBracketKeyword_10());
		}
	)
;
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.OBJECTIVE_TENDENCY");
				}
			)
		)
		(
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ENTITY_TYPE");
				}
			)
		)
		otherlv_4='{'
...
entryRuleModelInitialiserSpec returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getModelInitialiserSpecRule()); }
	iv_ruleModelInitialiserSpec=ruleModelInitialiserSpec
	{ $current=$iv_ruleModelInitialiserSpec.current; }
	EOF;

// Rule ModelInitialiserSpec
ruleModelInitialiserSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRulegenSpec returns [EObject current=null]:
	...
	{ $current=$iv_ruleRulegenSpec.current; }
	EOF;

// Rule RulegenSpec
ruleRulegenSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
				...
				(
					...
					lv_nodeSpec_2_0=ruleRulegenNode
					{
						...
						set(
							...
							"nodeSpec",
							lv_nodeSpec_2_0,
							"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.RulegenNode");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_edgeSpec_3_0=ruleRulegenEdge
					{
						...
						set(
							...
							"edgeSpec",
							lv_edgeSpec_3_0,
							"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.RulegenEdge");
						afterParserOrEnumRuleCall();
					}
				)
			)
...
entryRuleRulegenNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRulegenNodeRule()); }
	iv_ruleRulegenNode=ruleRulegenNode
	{ $current=$iv_ruleRulegenNode.current; }
	EOF;

// Rule RulegenNode
ruleRulegenNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			...
			(
				(
					(
						lv_generationRestriction_2_1=RULE_CREATE_NODE
						{
						...
						}
						{
							...
							setWithLastConsumed(
								...
								"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.CREATE_NODE");
						}
						    |
						lv_generationRestriction_2_2=RULE_DELETE_NODE
						{
						...
						}
						{
							...
							setWithLastConsumed(
								...
								"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.DELETE_NODE");
						}
					)
				)
			)
...
entryRuleRulegenEdge returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRulegenEdgeRule()); }
	iv_ruleRulegenEdge=ruleRulegenEdge
	{ $current=$iv_ruleRulegenEdge.current; }
	EOF;

// Rule RulegenEdge
ruleRulegenEdge returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			...
			(
				(
					(
						lv_generationRestriction_4_1=RULE_ADD_EDGE
						{
						...
						}
						{
							...
							setWithLastConsumed(
								...
								"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ADD_EDGE");
						}
						    |
						lv_generationRestriction_4_2=RULE_REMOVE_EDGE
						{
						...
						}
						{
							...
							setWithLastConsumed(
								...
								"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.REMOVE_EDGE");
						}
					)
				)
			)
			...
			(
				...
				lv_evolverType_0_0=ruleEvolverType
				{
					...
					set(
						...
						"evolverType",
						lv_evolverType_0_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.EvolverType");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_parameters_7_0=ruleEvolverParameter
					{
						...
						add(
							...
							"parameters",
							lv_parameters_7_0,
							"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.EvolverParameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
...
entryRuleMultiplicityRefinementSpec returns [EObject current=null]:
	...
	{ $current=$iv_ruleMultiplicityRefinementSpec.current; }
	EOF;

// Rule MultiplicityRefinementSpec
ruleMultiplicityRefinementSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
			...
			(
				...
				lv_upperBound_9_0=ruleSignedInteger
				{
					...
					set(
						...
						"upperBound",
						lv_upperBound_9_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.SignedInteger");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_function_2_0=ruleParameterFunction
						{
							...
							set(
								...
								"function",
								lv_function_2_0,
								"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ParameterFunction");
							afterParserOrEnumRuleCall();
						}
					)
				)
...
entryRuleAlgorithmSpec returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlgorithmSpecRule()); }
	iv_ruleAlgorithmSpec=ruleAlgorithmSpec
	{ $current=$iv_ruleAlgorithmSpec.current; }
	EOF;

// Rule AlgorithmSpec
ruleAlgorithmSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			(
				...
				{
					newLeafNode(lv_name_0_0, grammarAccess.getAlgorithmSpecAccess().getNameALGORITHM_NAMETerminalRuleCall_0_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getAlgorithmSpecRule());
					}
					setWithLastConsumed(
						$current,
						"name",
						lv_name_0_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ALGORITHM_NAME");
				}
			)
		)
		otherlv_1='{'
		...
		(
			(
				...
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getAlgorithmSpecRule());
					}
					add(
						$current,
						"parameters",
		...
		otherlv_3='}'
		{
			newLeafNode(otherlv_3, grammarAccess.getAlgorithmSpecAccess().getRightCurlyBracketKeyword_3());
		}
	)
;

// Entry rule entryRuleTerminationConditionSpec
entryRuleTerminationConditionSpec returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTerminationConditionSpecRule()); }
	iv_ruleTerminationConditionSpec=ruleTerminationConditionSpec
	{ $current=$iv_ruleTerminationConditionSpec.current; }
	EOF;

// Rule TerminationConditionSpec
ruleTerminationConditionSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			{
				$current = forceCreateModelElement(
					grammarAccess.getTerminationConditionSpecAccess().getTerminationConditionSpecAction_0(),
					$current);
			}
		)
		otherlv_1='{'
		...
		(
			(
				...
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getTerminationConditionSpecRule());
					}
					add(
						$current,
						"parameters",
			...
			(
				...
				lv_value_2_0=ruleParameterValue
				{
					...
					set(
						...
						"value",
						lv_value_2_0,
						"uk.ac.kcl.inf.mdeoptimiser.languages.Mopt.ParameterValue");
					afterParserOrEnumRuleCall();
				}
			)
		)
...
@after {
	...
	(
		(
			(
				{
					newCompositeNode(grammarAccess.getParameterValueAccess().getNumericNumberParserRuleCall_0_0());
				}
				lv_numeric_0_0=ruleNumber
				{
					if ($current==null) {
		...
		(
			(
				lv_functional_1_0=RULE_ID
				{
					newLeafNode(lv_functional_1_0, grammarAccess.getParameterValueAccess().getFunctionalIDTerminalRuleCall_1_0());
				}
				{
					if ($current==null) {
