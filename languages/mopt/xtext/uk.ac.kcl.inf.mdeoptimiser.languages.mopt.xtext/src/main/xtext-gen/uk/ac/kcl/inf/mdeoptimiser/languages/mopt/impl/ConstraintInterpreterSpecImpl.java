 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.mopt.impl.ConstraintInterpreterSpecImpl#getConstraintName <em>Constraint Name</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.mopt.impl.ConstraintInterpreterSpecImpl#getConstraintType <em>Constraint Type</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdeoptimiser.languages.mopt.impl.ConstraintInterpreterSpecImpl#getConstraintSpec <em>Constraint Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintInterpreterSpecImpl extends MinimalEObjectImpl.Container implements ConstraintInterpreterSpec
{
  ...
  {
    return MoptPackage.Literals.CONSTRAINT_INTERPRETER_SPEC;
  }
  ...
  public void setConstraintName(String newConstraintName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_NAME, oldConstraintName, constraintName));
  }
  ...
  public void setConstraintType(String newConstraintType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_TYPE, oldConstraintType, constraintType));
  }
  ...
  public void setConstraintSpec(String newConstraintSpec)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_SPEC, oldConstraintSpec, constraintSpec));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_NAME:
        return getConstraintName();
      case MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_TYPE:
        return getConstraintType();
      case MoptPackage.CONSTRAINT_INTERPRETER_SPEC__CONSTRAINT_SPEC:
