...
public class Run {
	...
	public void run(String moptRootPath, String moptFilePath, Integer batch) {
			...
			var mdeoResultsOutput = new MDEOResultsOutput(new Date(), Paths.get(moptRootPath), Paths.get(moptFilePath),
				optimisationModel);
	...
	public Optimisation loadOptimisationSpec(String moptFilePath) {
		...
		var resource = resourceSetProvider.get().getResource(URI.createFileURI(moptFile.getAbsolutePath()), true);
	 ...
	 */
	public void runParameterSearch(MDEOResultsOutput mdeoResultsOutput, String moptProjectPath, Optimisation optimisation) {
	 ...
	 */
	public void runSearch(MDEOResultsOutput mdeoResultsOutput, String moptProjectPath, Optimisation optimisationModel,
	 ...
	 */
	public MDEOBatch runBatch(String moptProjectPath, Optimisation optimisationModel, Integer batch, boolean singleBatch) {
		...
		var generatedRules = optimisationInterpreter.getRulegenOperators();
