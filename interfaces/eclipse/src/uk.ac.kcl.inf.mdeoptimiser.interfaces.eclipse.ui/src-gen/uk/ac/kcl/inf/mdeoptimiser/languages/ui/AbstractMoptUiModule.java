...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.PartialMoptContentAssistParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalMoptLexer;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.contentassist.MoptProposalProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.editor.MoptEditor;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.MoptDescriptionLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.labeling.MoptLabelProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.outline.MoptOutlineTreeProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.ui.quickfix.MoptQuickfixProvider;
import uk.ac.kcl.inf.mdeoptimiser.languages.validation.MoptValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link MoptUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMoptUiModule extends DefaultXbaseUiModule {

	public AbstractMoptUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(uk.ac.kcl.inf.mdeoptimiser.languages.parser.antlr.internal.InternalMoptLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMoptLexer.class).toProvider(LexerProvider.create(InternalMoptLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return MoptValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return MoptLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MoptDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return MoptOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return MoptQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MoptProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMoptContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Mopt Compare");
	}
