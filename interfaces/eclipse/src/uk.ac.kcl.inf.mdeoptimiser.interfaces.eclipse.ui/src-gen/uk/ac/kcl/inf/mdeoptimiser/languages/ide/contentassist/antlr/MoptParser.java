 ...
 */
package uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr;
...
import uk.ac.kcl.inf.mdeoptimiser.languages.ide.contentassist.antlr.internal.InternalMoptParser;
import uk.ac.kcl.inf.mdeoptimiser.languages.services.MoptGrammarAccess;

public class MoptParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MoptGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MoptGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getRulegenSpecAccess().getAlternatives_2(), "rule__RulegenSpec__Alternatives_2");
			builder.put(grammarAccess.getRulegenNodeAccess().getGenerationRestrictionAlternatives_1_1_0(), "rule__RulegenNode__GenerationRestrictionAlternatives_1_1_0");
			builder.put(grammarAccess.getRulegenEdgeAccess().getGenerationRestrictionAlternatives_3_1_0(), "rule__RulegenEdge__GenerationRestrictionAlternatives_3_1_0");
			builder.put(grammarAccess.getEvolverParameterAccess().getAlternatives_1_1(), "rule__EvolverParameter__Alternatives_1_1");
			builder.put(grammarAccess.getAlgorithmVariationAccess().getAlternatives(), "rule__AlgorithmVariation__Alternatives");
			builder.put(grammarAccess.getAlgorithmVariationAccess().getSimpleVariationAlternatives_1_0(), "rule__AlgorithmVariation__SimpleVariationAlternatives_1_0");
			...
			builder.put(grammarAccess.getEvolverTypeAccess().getAlternatives(), "rule__EvolverType__Alternatives");
			builder.put(grammarAccess.getOptimisationAccess().getGroup(), "rule__Optimisation__Group__0");
			builder.put(grammarAccess.getProblemSpecAccess().getGroup(), "rule__ProblemSpec__Group__0");
			builder.put(grammarAccess.getGoalSpecAccess().getGroup(), "rule__GoalSpec__Group__0");
			builder.put(grammarAccess.getSearchSpecAccess().getGroup(), "rule__SearchSpec__Group__0");
			...
			builder.put(grammarAccess.getRulegenEdgeAccess().getGroup(), "rule__RulegenEdge__Group__0");
			builder.put(grammarAccess.getRulegenEdgeAccess().getGroup_3(), "rule__RulegenEdge__Group_3__0");
			builder.put(grammarAccess.getReportInterpreterSpecAccess().getGroup(), "rule__ReportInterpreterSpec__Group__0");
			builder.put(grammarAccess.getEvolverSpecAccess().getGroup(), "rule__EvolverSpec__Group__0");
			builder.put(grammarAccess.getEvolverSpecAccess().getGroup_5(), "rule__EvolverSpec__Group_5__0");
			builder.put(grammarAccess.getEvolverSpecAccess().getGroup_5_3(), "rule__EvolverSpec__Group_5_3__0");
			builder.put(grammarAccess.getMultiplicityRefinementSpecAccess().getGroup(), "rule__MultiplicityRefinementSpec__Group__0");
			builder.put(grammarAccess.getEvolverParameterAccess().getGroup(), "rule__EvolverParameter__Group__0");
			builder.put(grammarAccess.getEvolverParameterAccess().getGroup_1(), "rule__EvolverParameter__Group_1__0");
			builder.put(grammarAccess.getParameterFunctionAccess().getGroup(), "rule__ParameterFunction__Group__0");
			builder.put(grammarAccess.getParameterFunctionAccess().getGroup_1(), "rule__ParameterFunction__Group_1__0");
			builder.put(grammarAccess.getOptimisationSpecAccess().getGroup(), "rule__OptimisationSpec__Group__0");
			builder.put(grammarAccess.getOptimisationSpecAccess().getGroup_11(), "rule__OptimisationSpec__Group_11__0");
			builder.put(grammarAccess.getProbabilityVariationAccess().getGroup(), "rule__ProbabilityVariation__Group__0");
			builder.put(grammarAccess.getProbabilityVariationAccess().getGroup_1(), "rule__ProbabilityVariation__Group_1__0");
			builder.put(grammarAccess.getSignedIntegerAccess().getGroup(), "rule__SignedInteger__Group__0");
			builder.put(grammarAccess.getAlgorithmParametersAccess().getGroup(), "rule__AlgorithmParameters__Group__0");
			builder.put(grammarAccess.getTerminationConditionParametersAccess().getGroup(), "rule__TerminationConditionParameters__Group__0");
			...
			builder.put(grammarAccess.getOptimisationAccess().getProblemAssignment_0(), "rule__Optimisation__ProblemAssignment_0");
			builder.put(grammarAccess.getOptimisationAccess().getGoalAssignment_1(), "rule__Optimisation__GoalAssignment_1");
			builder.put(grammarAccess.getOptimisationAccess().getSearchAssignment_2(), "rule__Optimisation__SearchAssignment_2");
			builder.put(grammarAccess.getOptimisationAccess().getSolverAssignment_3(), "rule__Optimisation__SolverAssignment_3");
			builder.put(grammarAccess.getProblemSpecAccess().getBasepathAssignment_2(), "rule__ProblemSpec__BasepathAssignment_2");
			...
			builder.put(grammarAccess.getSearchSpecAccess().getReportsAssignment_2(), "rule__SearchSpec__ReportsAssignment_2");
			builder.put(grammarAccess.getSearchSpecAccess().getEvolversAssignment_3(), "rule__SearchSpec__EvolversAssignment_3");
			builder.put(grammarAccess.getSearchSpecAccess().getRulegenAssignment_4(), "rule__SearchSpec__RulegenAssignment_4");
			builder.put(grammarAccess.getSolverSpecAccess().getOptimisationAssignment_2(), "rule__SolverSpec__OptimisationAssignment_2");
			...
			builder.put(grammarAccess.getObjectiveInterpreterSpecAccess().getObjectiveNameAssignment_1(), "rule__ObjectiveInterpreterSpec__ObjectiveNameAssignment_1");
			builder.put(grammarAccess.getObjectiveInterpreterSpecAccess().getObjectiveTendencyAssignment_2(), "rule__ObjectiveInterpreterSpec__ObjectiveTendencyAssignment_2");
			builder.put(grammarAccess.getObjectiveInterpreterSpecAccess().getObjectiveTypeAssignment_3(), "rule__ObjectiveInterpreterSpec__ObjectiveTypeAssignment_3");
			builder.put(grammarAccess.getObjectiveInterpreterSpecAccess().getObjectiveSpecAssignment_5(), "rule__ObjectiveInterpreterSpec__ObjectiveSpecAssignment_5");
			builder.put(grammarAccess.getConstraintInterpreterSpecAccess().getConstraintNameAssignment_1(), "rule__ConstraintInterpreterSpec__ConstraintNameAssignment_1");
			...
			builder.put(grammarAccess.getRulegenNodeAccess().getGenerationRestrictionAssignment_1_1(), "rule__RulegenNode__GenerationRestrictionAssignment_1_1");
			builder.put(grammarAccess.getRulegenEdgeAccess().getNodeAssignment_0(), "rule__RulegenEdge__NodeAssignment_0");
			builder.put(grammarAccess.getRulegenEdgeAccess().getEdgeAssignment_2(), "rule__RulegenEdge__EdgeAssignment_2");
			builder.put(grammarAccess.getRulegenEdgeAccess().getGenerationRestrictionAssignment_3_1(), "rule__RulegenEdge__GenerationRestrictionAssignment_3_1");
			builder.put(grammarAccess.getReportInterpreterSpecAccess().getReportNameAssignment_1(), "rule__ReportInterpreterSpec__ReportNameAssignment_1");
			builder.put(grammarAccess.getReportInterpreterSpecAccess().getReportSpecAssignment_3(), "rule__ReportInterpreterSpec__ReportSpecAssignment_3");
			builder.put(grammarAccess.getEvolverSpecAccess().getEvolverTypeAssignment_0(), "rule__EvolverSpec__EvolverTypeAssignment_0");
			builder.put(grammarAccess.getEvolverSpecAccess().getRule_locationAssignment_2(), "rule__EvolverSpec__Rule_locationAssignment_2");
			builder.put(grammarAccess.getEvolverSpecAccess().getUnitAssignment_4(), "rule__EvolverSpec__UnitAssignment_4");
			builder.put(grammarAccess.getEvolverSpecAccess().getParametersAssignment_5_2(), "rule__EvolverSpec__ParametersAssignment_5_2");
			builder.put(grammarAccess.getEvolverSpecAccess().getParametersAssignment_5_3_1(), "rule__EvolverSpec__ParametersAssignment_5_3_1");
			builder.put(grammarAccess.getMultiplicityRefinementSpecAccess().getNodeAssignment_3(), "rule__MultiplicityRefinementSpec__NodeAssignment_3");
			builder.put(grammarAccess.getMultiplicityRefinementSpecAccess().getEdgeAssignment_5(), "rule__MultiplicityRefinementSpec__EdgeAssignment_5");
			builder.put(grammarAccess.getMultiplicityRefinementSpecAccess().getLowerBoundAssignment_7(), "rule__MultiplicityRefinementSpec__LowerBoundAssignment_7");
			builder.put(grammarAccess.getMultiplicityRefinementSpecAccess().getUpperBoundAssignment_9(), "rule__MultiplicityRefinementSpec__UpperBoundAssignment_9");
			builder.put(grammarAccess.getEvolverParameterAccess().getNameAssignment_0(), "rule__EvolverParameter__NameAssignment_0");
			builder.put(grammarAccess.getEvolverParameterAccess().getFunctionAssignment_1_1_0(), "rule__EvolverParameter__FunctionAssignment_1_1_0");
			builder.put(grammarAccess.getEvolverParameterAccess().getCustomFunctionAssignment_1_1_1(), "rule__EvolverParameter__CustomFunctionAssignment_1_1_1");
			builder.put(grammarAccess.getParameterFunctionAccess().getNameAssignment_0(), "rule__ParameterFunction__NameAssignment_0");
			builder.put(grammarAccess.getParameterFunctionAccess().getParameterAssignment_1_1(), "rule__ParameterFunction__ParameterAssignment_1_1");
			builder.put(grammarAccess.getOptimisationSpecAccess().getAlgorithmFactoryAssignment_2(), "rule__OptimisationSpec__AlgorithmFactoryAssignment_2");
			builder.put(grammarAccess.getOptimisationSpecAccess().getAlgorithmNameAssignment_4(), "rule__OptimisationSpec__AlgorithmNameAssignment_4");
			builder.put(grammarAccess.getOptimisationSpecAccess().getAlgorithmVariationAssignment_6(), "rule__OptimisationSpec__AlgorithmVariationAssignment_6");
			builder.put(grammarAccess.getOptimisationSpecAccess().getAlgorithmParametersAssignment_8(), "rule__OptimisationSpec__AlgorithmParametersAssignment_8");
			builder.put(grammarAccess.getOptimisationSpecAccess().getTerminationConditionAssignment_10(), "rule__OptimisationSpec__TerminationConditionAssignment_10");
			builder.put(grammarAccess.getOptimisationSpecAccess().getAlgorithmBatchesAssignment_11_1(), "rule__OptimisationSpec__AlgorithmBatchesAssignment_11_1");
			builder.put(grammarAccess.getAlgorithmVariationAccess().getProbabilityVariationAssignment_0(), "rule__AlgorithmVariation__ProbabilityVariationAssignment_0");
			builder.put(grammarAccess.getAlgorithmVariationAccess().getSimpleVariationAssignment_1(), "rule__AlgorithmVariation__SimpleVariationAssignment_1");
			builder.put(grammarAccess.getProbabilityVariationAccess().getTypeAssignment_0(), "rule__ProbabilityVariation__TypeAssignment_0");
			builder.put(grammarAccess.getProbabilityVariationAccess().getCrossover_rateAssignment_1_1(), "rule__ProbabilityVariation__Crossover_rateAssignment_1_1");
			builder.put(grammarAccess.getProbabilityVariationAccess().getMutation_rateAssignment_1_3(), "rule__ProbabilityVariation__Mutation_rateAssignment_1_3");
			builder.put(grammarAccess.getAlgorithmParametersAccess().getParametersAssignment_1(), "rule__AlgorithmParameters__ParametersAssignment_1");
			builder.put(grammarAccess.getTerminationConditionParametersAccess().getParametersAssignment_1(), "rule__TerminationConditionParameters__ParametersAssignment_1");
	...
	@Override
	protected InternalMoptParser createParser() {
		InternalMoptParser result = new InternalMoptParser(null);
