...
public class MoptParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MoptGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParameterValueAccess().getParamsAlternatives_2_2_0_0(), "rule__ParameterValue__ParamsAlternatives_2_2_0_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAlternatives_2_2_1_1_0(), "rule__ParameterValue__ParamsAlternatives_2_2_1_1_0");
			...
			builder.put(grammarAccess.getSolverSpecAccess().getGroup_9(), "rule__SolverSpec__Group_9__0");
			...
			builder.put(grammarAccess.getParameterValueAccess().getGroup_2_2_1(), "rule__ParameterValue__Group_2_2_1__0");
			...
			builder.put(grammarAccess.getSolverSpecAccess().getAlgorithmFactoryAssignment_4(), "rule__SolverSpec__AlgorithmFactoryAssignment_4");
			builder.put(grammarAccess.getSolverSpecAccess().getAlgorithmAssignment_6(), "rule__SolverSpec__AlgorithmAssignment_6");
			builder.put(grammarAccess.getSolverSpecAccess().getTerminationConditionAssignment_8(), "rule__SolverSpec__TerminationConditionAssignment_8");
			builder.put(grammarAccess.getSolverSpecAccess().getAlgorithmBatchesAssignment_9_1(), "rule__SolverSpec__AlgorithmBatchesAssignment_9_1");
			...
			builder.put(grammarAccess.getParameterValueAccess().getFunctionalAssignment_1(), "rule__ParameterValue__FunctionalAssignment_1");
			builder.put(grammarAccess.getParameterValueAccess().getParametricAssignment_2_0(), "rule__ParameterValue__ParametricAssignment_2_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAssignment_2_2_0(), "rule__ParameterValue__ParamsAssignment_2_2_0");
			builder.put(grammarAccess.getParameterValueAccess().getParamsAssignment_2_2_1_1(), "rule__ParameterValue__ParamsAssignment_2_2_1_1");
